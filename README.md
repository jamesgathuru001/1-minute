...
* internet access
* $ git clone https://github.com/jamesgathuru001/1-minute.git
* $ cd one-minute-pitch
...
In case You have any issues using this code please do no hesitate to get in touch with me through jamesgathuru001@gmail.com or leave a commit here on github.
...
**[MIT](./LICENSE)** (c) 2019 **[James Gathuru](https://github.com/jamesgathuru001/1-minute.git)**